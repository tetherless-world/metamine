...
from metamine_visualization.agent import *
...
Config = dict(
    ...
    vocab_file = "/apps/metamine_visualization/vocab.ttl",
    WHYIS_TEMPLATE_DIR = [
        "/apps/metamine_visualization/templates",
    ],
    WHYIS_CDN_DIR = "/apps/metamine_visualization/static",
    ...
    ## MAIL_USERNAME = '',
    ## MAIL_PASSWORD = '',
    ## DEFAULT_MAIL_SENDER = "Neha Keshan <keshan@rpi.edu>",
    ...
    SECURITY_EMAIL_SENDER = "Neha Keshan <keshan@rpi.edu>",
    ...
    SECURITY_PASSWORD_SALT = 'P5h8Cf6fTuDWiehVdIcKnupEJzb1J5jm',
    ...
    java_classpath = "/apps/metamine_visualization/jars",
